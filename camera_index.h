...
<body>
    <div class="container">
        ...
        <div class="panel">
            <h2><i>🎥</i> Camera Settings</h2>
            <form id="settingsForm">
                <div class="form-group">
                    <label for="exposure">Exposure (ms)</label>
                    <input type="number" id="exposure" min="0" step="100" value="1000">
                </div>
                <div class="form-group">
                    <label for="iso">ISO</label>
                    <input type="number" id="iso" min="100" max="3200" step="100" value="400">
                </div>
                <div class="form-group">
                ...
                <button type="submit"><i>💾</i> Apply Settings</button>
            </form>
        </div>

        <!-- Queue Setup Panel -->
        <div class="panel">
            <h2><i>📋</i> Queue Setup</h2>
            <form id="queueForm">
                <div class="form-group">
                    ...
                    <select id="frameType">
                        ...
                        <option value="light">Light Frames</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <input type="text" id="savePath" value="~/ESP_Photos" readonly>
                        <button type="button" id="directoryPicker" class="success">
                            <i>📁</i> Browse...
                        </button>
                    </div>
                    <div id="directoryFallback" style="display: none; margin-top: 5px; color: var(--accent-red);">
                        Directory picker not supported. Please enter path manually.
                    </div>
                </div>
                <button type="submit"><i>➕</i> Add to Queue</button>
            </form>
        </div>

        <!-- Queue Status Panel -->
        <div class="panel full-width">
            <h2><i>📊</i> Queue Status</h2>
            <div id="queueStatus" class="status-badge stopped">Queue is stopped</div>
            
            <div class="progress-container">
                <div class="status">
                    <strong>Current Job:</strong> <span id="currentJobStatus">No active job</span>
                </div>
            ...
            <div style="margin-top: 20px; display: flex; gap: 10px;">
                <button id="pauseQueue"><i>⏸️</i> Pause Queue</button>
                <button id="resumeQueue" style="display: none;"><i>▶️</i> Resume Queue</button>
                <button id="cancelQueue" class="danger"><i>⏹️</i> Cancel Queue</button>
            </div>
        </div>

        <!-- Directory Browser Panel -->
        <div class="panel full-width">
            <h2><i>📂</i> Directory Browser</h2>
            <div class="directory-path" id="currentPath">
                <!-- Path segments will be inserted here -->
            </div>
            <div id="directoryBrowser" class="directory-browser">
                <!-- Directory contents will be inserted here -->
            </div>
        </div>
    </div>
